...
- [ ] Regenerate lockfile-derived SBOM, licence, readiness, package, dashboard, and handoff artifacts.
- [ ] Run deterministic regeneration and automated review.
- [ ] Merge through the protected workflow and archive only after every acceptance criterion passes.
