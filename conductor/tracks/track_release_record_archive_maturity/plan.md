...
- [~] REL-06: Generate a deterministic Zenodo/DataCite draft manifest for software plus permitted
...
- [ ] REL-08: Add a token-gated, dry-run-by-default deposition workflow that can create a draft,
