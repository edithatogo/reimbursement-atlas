...
`docs/HISTORICAL_SOURCE_BOUNDARIES.md`; acquisition totals are unchanged.
...
The dashboard review is complete as `approved_within_scope` for the current
...
registration `gqk4z` is active, public and immutable, completing the OSF
registration track. Its submitted freeze is preserved separately from the
current draft, which has post-registration protocol, manifest and source-cutoff
drift and therefore requires a new-version decision before any later
registration. Zenodo/DataCite deposition and the exact signed release remain
blocked by the four partial claim packages and their accountable evidence
review. Papers and preprints remain excluded.
...
`1135c3bc5cbab8d069b7d2c9e0f4680fae30fa7d`. Repository release readiness must be
...
`29595536363`, Zenodo `29595536320`, source health `29595536399`, Hugging Face
destination `29595536385`, and GitHub security settings `29595536535`.

The repo is now in the reviewed-source preparation and mapping-workbench phase. Historical
...
Merged `main` is `ef1826928c65d7702f0983742d69f14eff675079`. Non-mutating monitors completed on the preceding monitor snapshot;
...
`git rev-parse main`. The latest source-health acceptance run `29587300544` recorded successful acquisition, zero downstream
