...
- [x] REL-04: Generate reproducible archive, wheel, sdist, SBOM, provenance, release manifest and
...
- [x] REL-05: Run final release-readiness and publication boundary review; do not publish papers. (Subissue #507)
...
- [x] REL-09: Publish the versioned Zenodo record and verify DataCite DOI resolution only after
...
- [x] REL-11: After OSF destination deprecation, regenerate readiness and dashboard
...
- [x] REL-12: Deposit the verified release assets to one Zenodo concept record, verify remote
