...
- [x] SEC-01: Validate SHA-pinned workflow references and policy matrix. (`0ce00fef`)
- [x] SEC-02: Validate SBOM, provenance and attestation release contracts. (`0ce00fef`)
- [x] SEC-03: Validate branch-protection and security-workflow contracts. (`0ce00fef`)
