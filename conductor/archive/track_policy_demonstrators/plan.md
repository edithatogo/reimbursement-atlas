...
- [x] POL-04: Run all five protocolled analyses on reviewed derived source
...
- [x] POL-05: Produce one immutable claim package per question and complete
  scoped accountable review. Papers and preprints are excluded.
- [x] POL-06: Regenerate evidence, dashboard and release artefacts after all
  five current packages pass.

## Blocker sequence

The five packages regenerate deterministically with checksum-bound scoped
decisions. Evidence readiness reports 5/5 `evidence_ready`; release readiness
reports all 39 gates passing. Papers and preprints remain excluded.

The reviewed-source analysis and claim-package acceptance criteria are met for
the bounded claims recorded by the packages; no broader causal, coverage or
price-equivalence claim is implied.
