# Complete protocol and report: rq_cognitive_procedural
...
- [x] The protocol scaffold is present at `protocols/cognitive_procedural_relativity_protocol.md` and is linked to the machine-readable research-question registry.
- [x] The report scaffold is present at `reports/cognitive_procedural_relativity_report.md` and its expected outputs and dataset linkages are recorded.
