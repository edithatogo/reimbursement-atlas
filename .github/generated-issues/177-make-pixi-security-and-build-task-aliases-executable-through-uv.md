# Make Pixi security and build task aliases executable through uv

Epic: `SEC-020` — Continuous security assurance and branch enforcement

Labels: type:toolchain, type:security, type:supply-chain, phase:hardening, status:implemented
