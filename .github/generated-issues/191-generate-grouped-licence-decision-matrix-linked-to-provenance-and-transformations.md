# Generate grouped licence decision matrix linked to provenance and transformations

Epic: `EVID-017` — Evidence readiness, source drift and data dictionary gates

Labels: type:publication, type:provenance, type:review, risk:licence, phase:release-gate, status:implemented
