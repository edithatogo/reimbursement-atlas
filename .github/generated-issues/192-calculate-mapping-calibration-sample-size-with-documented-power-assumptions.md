# Calculate mapping calibration sample size with documented power assumptions

Epic: `EVID-017` — Evidence readiness, source drift and data dictionary gates

Labels: type:mapping, type:research, type:data-quality, phase:release-gate, status:implemented
