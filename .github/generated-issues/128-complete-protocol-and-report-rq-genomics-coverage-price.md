# Complete protocol and report: rq_genomics_coverage_price
...
- [x] The protocol scaffold is present at `protocols/genomics_pathology_protocol.md` and is linked to the machine-readable research-question registry.
- [x] The report scaffold is present at `reports/genomics_pathology_report.md` and its expected outputs and dataset linkages are recorded.
