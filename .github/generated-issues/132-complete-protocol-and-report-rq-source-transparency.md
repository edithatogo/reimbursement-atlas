# Complete protocol and report: rq_source_transparency
...
- [x] The protocol scaffold is present at `protocols/source_transparency_protocol.md` and is linked to the machine-readable research-question registry.
- [x] The report scaffold is present at `reports/source_transparency_report.md` and its expected outputs and dataset linkages are recorded.
