...
- Item count: 4
- Metric summary: Compared genomics items across 6 sources; 4 items found, 50.0% with a public schedule amount. No pooled payment statistic is calculated across unharmonised sources.
- Caveats:
...
- Sources compared: ['au_mbs', 'au_pbs', 'uk_genomic_test_directory', 'us_cms_asp', 'us_cms_clfs', 'us_cms_pfs']
- Item count: 4
- Metric summary: Medicine items across 6 sources; 4 items, 4 with public price, public schedule amount missingness 0.0.
- Caveats:
