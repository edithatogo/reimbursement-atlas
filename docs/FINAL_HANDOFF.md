...
The current merged release is `adf0832` (resolve the current value with `git rev-parse main`). The repository-controlled
...
Latest read-only external evidence before `adf0832`: OSF plan run
