...
| PBS public API acquisition | endpoint identified; subscription key and monthly extract pending | `docs/PBS_API_ACQUISITION.md`, GitHub issue [#25](https://github.com/edithatogo/reimbursement-atlas/issues/25) | Confirm the current Swagger request URL, provide the key through an external secret, then review the selected monthly fields before parsing or publication. |
