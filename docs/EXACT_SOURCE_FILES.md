...
| `au_pbs_api_v3_documentation` | PBS v3 `/schedules` endpoint; the public API exposes a rolling thirteen-month schedule window, while the catalogue and documentation remain the evidence links for the endpoint family. |
